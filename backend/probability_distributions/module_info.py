...
def register(registry: ModuleRegistry) -> None:
    ...
    module_info = {
        ...
        "tutorials": [
            {"title": "Introduction to Probability Distributions", "url": "/tutorials/distributions/intro"},
            {"title": "Continuous vs. Discrete Distributions", "url": "/tutorials/distributions/continuous-discrete"},
            {"title": "Working with the Normal Distribution", "url": "/tutorials/distributions/normal"},
            {"title": "Binomial and Poisson Distributions", "url": "/tutorials/distributions/discrete"},
            {"title": "Fitting Distributions to Data", "url": "/tutorials/distributions/fitting"},
            {"title": "Central Limit Theorem Simulation", "url": "/tutorials/distributions/clt"},
        ],
    }
