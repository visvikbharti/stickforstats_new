...
class ProbabilityCalculationSerializer(serializers.Serializer):
    ...
    probability_type = serializers.CharField(
        required=False, default="less_than"
    )  # 'less_than', 'greater_than', 'between', 'exactly'
...
class BinomialApproximationRequestSerializer(serializers.Serializer):
    ...
    approximation_types = serializers.ListField(child=serializers.CharField(), default=["POISSON", "NORMAL"])


class DataFittingRequestSerializer(serializers.Serializer):
    data = serializers.ListField(child=serializers.FloatField())
    distribution_types = serializers.ListField(
        child=serializers.CharField(), default=["NORMAL", "POISSON", "BINOMIAL", "EXPONENTIAL", "GAMMA", "LOGNORMAL"]
    )
