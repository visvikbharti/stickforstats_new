...
def register(registry: ModuleRegistry) -> None:
    ...
    module_info = {
        ...
        "tutorials": [
            {"title": "Getting Started with PCA Analysis", "url": "/tutorials/pca/intro"},
            {"title": "Understanding PCA Visualizations", "url": "/tutorials/pca/visualizations"},
            {"title": "Gene Expression Analysis with PCA", "url": "/tutorials/pca/gene-analysis"},
            {"title": "Interpreting Loading Plots", "url": "/tutorials/pca/loading-plots"},
            {"title": "Group Analysis and Clustering", "url": "/tutorials/pca/group-analysis"},
        ],
    }
