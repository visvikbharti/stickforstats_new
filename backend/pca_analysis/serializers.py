...
class GeneContributionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "gene", "gene_name", "pc1_contribution", "pc2_contribution", "total_contribution"]
...
class FileUploadSerializer(serializers.Serializer):
    ...
    scaling_method = serializers.ChoiceField(
        choices=[("STANDARD", "Standard (Z-score)"), ("MINMAX", "Min-Max (0-1)"), ("NONE", "None")], default="STANDARD"
    )
