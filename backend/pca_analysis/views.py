...
class PCAProjectViewSet(viewsets.ModelViewSet):
    ...
    def upload_data(self, request):
        ...
        project = PCAProject.objects.create(
            name=project_name, description=project_description, user=request.user, scaling_method=scaling_method
        )
    ...
    def run_pca(self, request, pk=None):
        ...
        try:
            ...
            return Response(
                {"error": str(e), "message": "PCA analysis failed", "status": "failed"},
    ...
    def latest_result(self, request, pk=None):
        ...
        if not result:
            return Response({"error": "No PCA results found for this project"}, status=status.HTTP_404_NOT_FOUND)
...
class PCAResultViewSet(viewsets.ModelViewSet):
    ...
    def visualization_data(self, request, pk=None):
        ...
        _ = request.query_params.get("include_gene_loadings", "false").lower() == "true"
        ...
        try:
            ...
            visualization_data = {"plot_type": plot_type, "data": {}}
            ...
            if plot_type == "2d_scatter":
                ...
                visualization_data["data"] = {"loadings": pca_data["loadings"], "top_genes_count": top_genes_count}
...
class PCAVisualizationViewSet(viewsets.ModelViewSet):
    ...
    def data(self, request, result_pk=None, pk=None):
        ...
        if visualization.plot_type == "2d_scatter":
            ...
            data = {"explained_variance": result.explained_variance, "cumulative_variance": result.cumulative_variance}
        elif visualization.plot_type == "loadings":
            data = {"loadings": pca_data["loadings"], "top_genes_count": visualization.top_genes_count}
        else:
            data = {}

        return Response({"visualization": PCAVisualizationSerializer(visualization).data, "data": data})
        ...
        try:
            ...
            if "data_matrix" in data:
                ...
                return Response(
                    {
                        "status": "error",
                        "error": {"code": "NO_DATA", "message": "No data provided. Use data_matrix or csv_data"},
                    },
            ...
            return Response(
                {"status": "error", "error": {"code": "PCA_ERROR", "message": str(e)}},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
    ...
    def post(self, request):
        ...
        try:
            ...
            if viz_type == "biplot":
                ...
                visualization = create_sample_trajectory(viz_result, sample_order=data.get("time_points", None))
            else:
                visualization = None
            ...
            return Response(
                {"status": "error", "error": {"code": "VISUALIZATION_ERROR", "message": str(e)}},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
...
class GeneContributionView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            viz_result = _QuickPCAResult(scores=None, loadings=loadings.tolist(), explained_variance_ratio=[])
            ...
            return Response(
                {
                    "status": "success",
                    "data": {"results": results, "visualizations": visualizations},
            ...
            return Response(
                {"status": "error", "error": {"code": "CONTRIBUTION_ERROR", "message": str(e)}},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
...
class PCAComparisonView(APIView):
        ...
        try:
            ...
            if len(comparison_results) == 2:
                visualizations["procrustes"] = self._perform_procrustes_analysis(
                    comparison_results[0]["pca_scores"], comparison_results[1]["pca_scores"]
                )

            return Response(
                {
                    "status": "success",
                    "data": {"comparison_results": comparison_results, "visualizations": visualizations},
            ...
            return Response(
                {"status": "error", "error": {"code": "COMPARISON_ERROR", "message": str(e)}},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
    ...
    def _perform_procrustes_analysis(self, scores1, scores2):
        ...
        return {"disparity": float(disparity), "aligned_scores1": mtx1.tolist(), "aligned_scores2": mtx2.tolist()}
    ...
    def get(self, request):
        ...
        try:
            ...
            explanation = {
                ...
                "interactive_elements": ["drag_to_rotate", "click_to_highlight", "slider_for_components"],
            }
...
class DemoDataView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return Response(
                {
                    "status": "success",
                    "data": {"dataset": data.tolist(), "metadata": metadata},
    ...
    def _generate_iris_extended_demo(self):
        ...
        metadata = {
            ...
            + ["Sepal_Length_Derived", "Petal_Length_Derived", "Random_Feature_1", "Random_Feature_2"],
    ...
    def _generate_time_series_demo(self):
        ...
        metadata = {
            "sample_names": [
                f"T{timepoints[i//n_samples_per_timepoint]}_S{i%n_samples_per_timepoint+1}" for i in range(len(data))
            ],
            "gene_names": [f"Gene_{i+1}" for i in range(n_genes)],
