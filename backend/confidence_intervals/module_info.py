...
def register(registry: ModuleRegistry) -> None:
    ...
    module_info = {
        ...
        "tutorials": [
            {"title": "Understanding Confidence Intervals", "url": "/tutorials/ci/introduction"},
            {"title": "Interval Calculation Methods", "url": "/tutorials/ci/calculation-methods"},
            {"title": "Bootstrap Simulation Tutorial", "url": "/tutorials/ci/bootstrap"},
            {"title": "Coverage Probability Simulation", "url": "/tutorials/ci/coverage"},
            {"title": "Sample Size and Interval Width", "url": "/tutorials/ci/sample-size"},
            {"title": "Visualizing Confidence Intervals", "url": "/tutorials/ci/visualization"},
        ],
    }
