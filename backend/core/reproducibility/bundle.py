...
class ReproducibilityBundle:
    ...
    def add_test_result(self, test_name: str, result: Dict[str, Any]) -> None:
        ...
        test_record = {"test_name": test_name, "timestamp": datetime.now().isoformat(), **result}
    ...
    def add_effect_size(self, effect_type: str, result: Dict[str, Any]) -> None:
        ...
        effect_record = {"effect_type": effect_type, "timestamp": datetime.now().isoformat(), **result}
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.environment:
            bundle_dict["environment"]["created_at"] = self.environment.created_at.isoformat()

        # Convert DataFrames to dict format
        if self.tables:
            bundle_dict["tables"] = [table.to_dict("records") for table in self.tables]
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ReproducibilityBundle":
        ...
        if "tables" in data and data["tables"]:
            data["tables"] = [pd.DataFrame(table) for table in data["tables"]]
