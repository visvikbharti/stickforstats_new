...
class SeedManager:
    ...
    def _generate_module_seeds(self) -> None:
        ...
        np.random.RandomState(self.master_seed)
    ...
    def set_all_seeds(self) -> None:
        ...
        self.seed_history.append(
            {"action": "set_all_seeds", "master_seed": self.master_seed, "timestamp": self._get_timestamp()}
        )
    ...
    def verify_reproducibility(self, func: Callable, n_runs: int = 3, *args, **kwargs) -> bool:
        """
