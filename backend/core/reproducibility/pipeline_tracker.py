...
class PipelineTracker:
    ...
    @contextmanager
    def track_context(self, name: str, module: Optional[str] = None, metadata: Optional[Dict[str, Any]] = None):
        """
    ...
    def _capture_parameters(self, func: Callable, args: tuple, kwargs: dict) -> Dict[str, Any]:
    ...
    def get_pipeline_graph(self) -> Dict[str, Any]:
        ...
        for step in self.steps:
            ...
            for child_id in step.children_step_ids:
                edges.append({"from": step.step_id, "to": child_id})
