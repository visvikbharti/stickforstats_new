...
class LMMDiagnostics:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            "convergence": {"converged": self.converged, "warnings": self.convergence_warnings},
            "residuals": {"normality": self.residual_normality, "homoscedasticity": self.residual_homoscedasticity},
            "random_effects": {"normality": self.random_effects_normality},
            "influence": {
...
def residual_diagnostics(lmm_result, data=None, outcome_var: str = None) -> Dict[str, Any]:
    """
    ...
    homoscedasticity_result = {
        ...
        "interpretation": (
            "Evidence of heteroscedasticity - variance not constant"
            if p_value_het < 0.05
    ...
    qq_plot = {"theoretical": theoretical.tolist(), "observed": observed_sorted.tolist()}
    ...
    return {
        ...
        "summary": summary,
        "qq_plot": qq_plot,
        "residuals_vs_fitted": {"fitted": fitted.tolist(), "residuals": residuals.tolist()},
    }
...
def influence_diagnostics(lmm_result, data=None, grouping_var: str = None) -> Dict[str, Any]:
    """
    ...
    return {
        ...
        "threshold_used": {"groups": "z-score > 2", "observations": "standardized residual > 3"},
