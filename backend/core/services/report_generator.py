...
class ReportGenerator:
    ...
    def _setup_custom_styles(self):
        ...
        self.styles.add(
            ParagraphStyle(
                name="CustomBody", parent=self.styles["BodyText"], fontSize=11, alignment=TA_JUSTIFY, spaceAfter=12
            )
        )

    def generate_report(
        self, analysis_type: str, results: Dict[str, Any], metadata: Dict[str, Any] = None, format: str = "pdf"
    ) -> bytes:
        """
    ...
    def _generate_pdf_report(self, analysis_type: str, results: Dict[str, Any], metadata: Dict[str, Any]) -> bytes:
        ...
        elements.append(
            Paragraph(f"<b>Analysis Type:</b> {analysis_type.replace('_', ' ').title()}", self.styles["CustomBody"])
        )
    ...
    def _generate_results_text(self, analysis_type: str, results: Dict[str, Any]) -> str:
        ...
        if analysis_type == "t_test":
            ...
            if "ci_lower" in results and "ci_upper" in results:
                ci_text = self.apa_formatter.format_confidence_interval(results["ci_lower"], results["ci_upper"])
    ...
    def _generate_html_report(self, analysis_type: str, results: Dict[str, Any], metadata: Dict[str, Any]) -> bytes:
...
def generate_report(
    analysis_type: str, results: Dict[str, Any], metadata: Dict[str, Any] = None, format: str = "pdf"
) -> bytes:
    """
