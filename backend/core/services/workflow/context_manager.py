...
class WorkflowContext:
    ...
    def set_data(self, data: Union[pd.DataFrame, np.ndarray, dict], data_name: str = "primary") -> None:
        """
    ...
    def set_parameter(self, key: str, value: Any, category: str = "general") -> None:
        ...
        self._add_to_history("parameter_set", {"key": key, "value": str(value), "category": category})

        self.last_modified = datetime.now()

    def get_parameter(self, key: str, category: str = "general", default: Any = None) -> Any:
        """
    ...
    def add_result(self, result_key: str, result_data: Dict[str, Any], result_type: str = "analysis") -> None:
        """
        ...
        self._add_to_history("result_added", {"key": result_key, "type": result_type})
    ...
    def _add_to_history(self, action: str, details: Dict[str, Any]) -> None:
        ...
        self.history.append({"timestamp": datetime.now().isoformat(), "action": action, "details": details})
        ...
        for result_type, results in self.results.items():
            ...
            for key, value in results.items():
                ...
                if isinstance(value, pd.DataFrame):
                    serialized[result_type][key] = {"type": "dataframe", "data": value.to_dict()}
                elif isinstance(value, np.ndarray):
                    serialized[result_type][key] = {"type": "ndarray", "data": value.tolist()}
                else:
