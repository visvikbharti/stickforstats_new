...
class NavigationController:
    ...
    def get_available_actions(self, step: str) -> List[Dict[str, Any]]:
        ...
        # Common actions
        actions.append({"id": "save_progress", "label": "Save Progress", "icon": "save", "type": "utility"})
    ...
    def get_progress(self) -> Dict[str, Any]:
        ...
        required_steps = sum(1 for step in self.decision_tree.values() if step.get("required", False))
