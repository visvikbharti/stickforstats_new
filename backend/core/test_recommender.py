...
from .data_profiler import DatasetProfile, VariableType
...
class TestRecommendationEngine:
    ...
    def recommend_tests(
        ...
        if research_question is None:
            research_question = self._infer_research_question(profile, dependent_variable, independent_variables)
        ...
        for test_name, test_info in candidate_tests.items():
            recommendation = self._evaluate_test(
                test_name, test_info, profile, dependent_variable, independent_variables, data
            )
                    ...
                    if recommendation.robust_alternative:
                        ...
                        if alt_test_name in self.test_database:
                            ...
                            alt_recommendation = self._evaluate_test(
                                alt_test_name, alt_test_info, profile, dependent_variable, independent_variables, data
                            )
                            if alt_recommendation:
                                ...
                                alt_recommendation.warnings.append(f"Recommended as robust alternative to {test_name}")
    ...
    def _build_test_database(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "one_sample_t_test": {
                ...
                "requirements": {"n_continuous": 1, "n_groups": 0, "min_sample_size": 20},
                "assumptions": ["normality", "independence", "random_sampling"],
            ...
            "independent_t_test": {
                ...
                "research_questions": [ResearchQuestion.COMPARISON],
                "requirements": {"n_continuous": 1, "n_groups": 2, "min_sample_size": 20},
            ...
            "paired_t_test": {
                ...
                "research_questions": [ResearchQuestion.COMPARISON],
                "requirements": {"n_continuous": 2, "n_groups": 0, "min_sample_size": 20, "paired_data": True},
            ...
            "one_way_anova": {
                ...
                "research_questions": [ResearchQuestion.COMPARISON],
                "requirements": {"n_continuous": 1, "n_groups": 3, "min_sample_size": 30},  # 3 or more
                "assumptions": ["normality", "homogeneity_of_variance", "independence"],
            ...
            "two_way_anova": {
                ...
                "research_questions": [ResearchQuestion.COMPARISON],
                "requirements": {"n_continuous": 1, "n_categorical": 2, "min_sample_size": 40},
                "assumptions": ["normality", "homogeneity_of_variance", "independence"],
            ...
            "mann_whitney_u": {
                ...
                "research_questions": [ResearchQuestion.COMPARISON],
                "requirements": {"n_continuous": 1, "n_groups": 2, "min_sample_size": 10},
            ...
            "wilcoxon_signed_rank": {
                ...
                "research_questions": [ResearchQuestion.COMPARISON],
                "requirements": {"n_continuous": 2, "n_groups": 0, "min_sample_size": 10, "paired_data": True},
            ...
            "kruskal_wallis": {
                ...
                "research_questions": [ResearchQuestion.COMPARISON],
                "requirements": {"n_continuous": 1, "n_groups": 3, "min_sample_size": 15},
                "assumptions": ["independence", "ordinal_scale"],
            ...
            "pearson_correlation": {
                ...
                "requirements": {"n_continuous": 2, "min_sample_size": 30},
            ...
            "spearman_correlation": {
                ...
                "research_questions": [ResearchQuestion.RELATIONSHIP],
                "requirements": {"n_continuous": 2, "min_sample_size": 10},
                "assumptions": ["monotonic_relationship", "ordinal_scale"],
            ...
            "linear_regression": {
                ...
                "requirements": {"n_continuous": 2, "min_sample_size": 50},
                "assumptions": ["linearity", "independence", "homoscedasticity", "normality_of_residuals"],
            ...
            "multiple_regression": {
                ...
                "research_questions": [ResearchQuestion.PREDICTION],
                "requirements": {"n_continuous": 3, "min_sample_size": 100},
                "assumptions": [
                    "linearity",
                    "independence",
                    "homoscedasticity",
            ...
            "logistic_regression": {
                ...
                "requirements": {"n_binary": 1, "n_predictors": 1, "min_sample_size": 100},
                "assumptions": ["independence", "linearity_of_logit", "no_multicollinearity"],
            ...
            "chi_square_independence": {
                ...
                "research_questions": [ResearchQuestion.RELATIONSHIP],
                "requirements": {"n_categorical": 2, "min_sample_size": 20},
                "assumptions": ["independence", "expected_frequencies_5+"],
            ...
            "fisher_exact": {
                ...
                "research_questions": [ResearchQuestion.RELATIONSHIP],
                "requirements": {"n_binary": 2, "min_sample_size": 5},
            ...
            "manova": {
                ...
                "research_questions": [ResearchQuestion.COMPARISON],
                "requirements": {"n_continuous": 2, "n_groups": 2, "min_sample_size": 50},
                "assumptions": ["multivariate_normality", "homogeneity_of_covariance", "independence"],
            ...
            "pca": {
                ...
                "requirements": {"n_continuous": 3, "min_sample_size": 100},
                "assumptions": ["linearity", "adequate_correlations"],
                ...
                "branches": {
                    ResearchQuestion.COMPARISON: {
                        ...
                        "branches": {
                            ...
                            "3+": {
                                "question": "Normality met?",
                                "branches": {True: ["one_way_anova", "two_way_anova"], False: ["kruskal_wallis"]},
                            },
                        },
                    },
    ...
    def _infer_research_question(
        self, profile: DatasetProfile, dependent_variable: Optional[str], independent_variables: Optional[List[str]]
    ) -> ResearchQuestion:
        """
        ...
        continuous_vars = sum(1 for v in profile.variables.values() if v.type == VariableType.CONTINUOUS)
        categorical_vars = sum(
            1 for v in profile.variables.values() if v.type in [VariableType.NOMINAL, VariableType.BINARY]
        )
    ...
    def _get_candidate_tests(self, research_question: ResearchQuestion) -> Dict[str, Dict[str, Any]]:
        """
    ...
    def _evaluate_test(
        ...
        continuous_vars = [name for name, v in profile.variables.items() if v.type == VariableType.CONTINUOUS]
        categorical_vars = [
            name for name, v in profile.variables.items() if v.type in [VariableType.NOMINAL, VariableType.BINARY]
        ]
        _ = [name for name, v in profile.variables.items() if v.type == VariableType.BINARY]
        ...
        for assumption in recommendation.assumptions:
            met, assumption_result = self._check_assumption(
                assumption, profile, dependent_variable, independent_variables, data
            )
        ...
        recommendation = self._set_alternatives_based_on_violations(recommendation, test_name, assumption_results)
        ...
        if recommendation.assumption_violations:
            recommendation.warnings.append(f"Assumptions violated: {', '.join(recommendation.assumption_violations)}")
    ...
    def _check_assumption(
        ...
        independent_variables: Optional[List[str]] = None,
        data: Optional[pd.DataFrame] = None,
    ) -> Tuple[bool, Optional[AssumptionResult]]:
        """
        ...
        if data is not None and not data.empty:
            ...
            if "normality" in assumption:
                if dependent_variable and dependent_variable in data.columns:
                    ...
                    continuous_cols = [
                        col for col, var in profile.variables.items() if var.type == VariableType.CONTINUOUS
                    ]
            ...
            # No multicollinearity
                ...
                if independent_variables and len(independent_variables) > 1:
                    ...
                    if len(indep_cols) > 1:
                        ...
                        if len(X) > 0:
                            result = self.assumption_checker.check_multicollinearity(X.values, feature_names=indep_cols)
        ...
        if result is None:
            ...
            if "normality" in assumption:
                if dependent_variable and dependent_variable in profile.variables:
                    ...
                    continuous_vars = [v for v in profile.variables.values() if v.type == VariableType.CONTINUOUS]
                    if continuous_vars:
                        is_met = all(
                            v.normality_p_value > self.alpha for v in continuous_vars if v.normality_p_value is not None
                        )
                        return is_met, None
    ...
    def _set_alternatives_based_on_violations(
        self, recommendation: TestRecommendation, test_name: str, assumption_results: List[AssumptionResult]
    ) -> TestRecommendation:
        """
        ...
        normality_violated = any(
            r.assumption_type == AssumptionType.NORMALITY and not r.is_met for r in assumption_results
        )
        homoscedasticity_violated = any(
            r.assumption_type == AssumptionType.HOMOSCEDASTICITY and not r.is_met for r in assumption_results
        )
        _ = any(
            r.assumption_type == AssumptionType.INDEPENDENCE and not r.is_met for r in assumption_results
        )
        outliers_present = any(
            r.assumption_type == AssumptionType.NO_OUTLIERS and not r.is_met for r in assumption_results
        )
        ...
        if test_name == "independent_t_test":
            ...
            expected_freq_violated = any(
                r.assumption_type == AssumptionType.EXPECTED_FREQUENCIES and not r.is_met for r in assumption_results
            )
    ...
    def _set_alternatives(self, recommendation: TestRecommendation, test_name: str) -> TestRecommendation:
        """
        ...
        """
        alternatives = {
            "independent_t_test": {"non_parametric": "mann_whitney_u", "robust": "welch_t_test"},
            "paired_t_test": {"non_parametric": "wilcoxon_signed_rank"},
            "one_way_anova": {"non_parametric": "kruskal_wallis"},
            "pearson_correlation": {"non_parametric": "spearman_correlation"},
        }
    ...
    def generate_recommendation_report(self, recommendations: List[TestRecommendation]) -> str:
        """
