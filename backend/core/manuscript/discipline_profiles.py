...
_CONSORT_CHECKLIST: List[ChecklistItem] = [
    ...
    ChecklistItem(
        ...
        description=(
            'CONSORT 2010 Item 19: All important harms or unintended '
    ...
    ChecklistItem(
        ...
        description=(
            'CONSORT 2010 Item 23: Registration number and name of '
            'trial registry.'
        ),
        required=True,
        detection_pattern=(
...
_STROBE_CHECKLIST: List[ChecklistItem] = [
    ...
    ChecklistItem(
        ...
        description=(
            'STROBE Item 9: Describe any efforts to address potential '
            'sources of bias.'
        ),
        required=True,
        detection_pattern=(
    ...
    ChecklistItem(
        ...
        description=(
            'STROBE Item 12c: Explain how missing data were addressed.'
        ),
        required=True,
        detection_pattern=(
    ...
    ChecklistItem(
        ...
        description=(
            'STROBE Item 12e: Describe any sensitivity analyses.'
        ),
        required=False,
        detection_pattern=(
...
_JARS_QUANT_CHECKLIST: List[ChecklistItem] = [
    ...
    ChecklistItem(
        ...
        description=(
            'JARS-Quant Table 5: Report confidence intervals for '
            'effect-size estimates. 95 % CIs are standard.'
        ),
        required=True,
        detection_pattern=(
            r'(?:confidence\s+interval|CI)\s*[=:]?\s*[\[\(]?\s*-?\d'
    ...
    ChecklistItem(
        ...
        description=(
            'JARS-Quant Table 5: Describe the frequency and methods '
            'of handling missing data, if applicable.'
        ),
        required=False,
        detection_pattern=(
...
def get_profile(field_name: str) -> DisciplineProfile:
    ...
    if profile is None:
        ...
        raise ValueError(
            f"Unknown discipline field '{field_name}'. "
...
def evaluate_checklist(
    ...
    for item in profile.checklist:
        ...
        try:
            ...
            logger.warning(
                "Regex error in checklist item %s: %s", item.id, exc
            )
