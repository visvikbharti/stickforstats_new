...
def test_upload_data():
    ...
    try:
        ...
        with open(TEST_DATA_FILE, "rb") as f:
            ...
            data = {"file_type": "csv", "delimiter": ",", "has_header": "true"}

            response = requests.post(f"{API_BASE_URL}/test-recommender/upload-data/", files=files, data=data)
...
def test_check_assumptions(data_id):
    ...
    try:
        ...
        response = requests.post(f"{API_BASE_URL}/test-recommender/check-assumptions/", json=payload)
...
def test_recommend_test(data_id):
    ...
    try:
        ...
        response = requests.post(f"{API_BASE_URL}/test-recommender/recommend/", json=payload)
...
def test_run_test(data_id, test_type):
    ...
    try:
        ...
        response = requests.post(f"{API_BASE_URL}/test-recommender/run-test/", json=payload)
