...
from .power_views import (
    ...
    calculate_sample_size_chi_square,
    calculate_power_nonparametric,
    calculate_sample_size_nonparametric,
    power_curve,
...
urlpatterns = [
    ...
    path(
        "power/sample-size/chi-square/",
        calculate_sample_size_chi_square,
        name="sample-size-chi-square",
    ),
    path("power/nonparametric/", calculate_power_nonparametric, name="power-nonparametric"),
    path(
        "power/sample-size/nonparametric/",
        calculate_sample_size_nonparametric,
        name="sample-size-nonparametric",
    ),
    path("power/curves/", create_power_curves, name="power-curves"),
    path("power/curve/", power_curve, name="power-curve"),
    path("power/mde/", minimum_detectable_effect, name="power-mde"),
