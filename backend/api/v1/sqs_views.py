...
from core.sqs_scoring import (
    SQSScorer, SQSReportGenerator, analyze_manuscript
)
from core.sqs_rules import (
    ALL_RULES, CATEGORIES, FIELD_WEIGHTS, RULE_SUMMARY
)
...
class SQSCategoriesView(APIView):
    ...
    def get(self, request):
        ...
        return Response({
            ...
            'total_max_points': sum(c['max_points'] for c in CATEGORIES.values())
        })
