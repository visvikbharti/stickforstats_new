...
class TestEconomicDesignService(unittest.TestCase):
    ...
    def test_compare_design_alternatives(self):
        ...
        result = self.service.compare_design_alternatives(
            process_parameters=self.process_parameters, cost_parameters=self.cost_parameters, alternatives=alternatives
        )
    ...
    def test_calculate_cost_of_quality(self):
        ...
        self.assertAlmostEqual(summary["conformance_cost"], prevention_total + appraisal_total, places=2)

        # Nonconformance = internal + external failures
        self.assertAlmostEqual(summary["nonconformance_cost"], internal_total + external_total, places=2)
