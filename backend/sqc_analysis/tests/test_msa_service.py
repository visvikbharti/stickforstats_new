...
class TestMSAService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for part in range(1, parts + 1):
            ...
            for operator in range(1, operators + 1):
                ...
                for replicate in range(1, replicates + 1):
                    ...
                    data.append(
                        {"Part": f"Part_{part}", "Operator": f"Operator_{operator}", "Measurement": measurement}
                    )
        ...
        for ref in reference_values:
            for rep in range(replicates):
                ...
                data.append({"Reference": ref, "Measurement": measurement})
    ...
    def test_calculate_gauge_rr_anova(self):
        ...
        result = self.service.calculate_gauge_rr_anova(
            data=self.gauge_rr_data, parts_col="Part", operators_col="Operator", measurements_col="Measurement"
        )
    ...
    def test_analyze_linearity_bias(self):
        ...
        result = self.service.analyze_linearity_bias(
            data=self.linearity_data, reference_col="Reference", measurement_col="Measurement"
        )
