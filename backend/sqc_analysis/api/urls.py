...
from sqc_analysis.api.views import (
    ...
    AcceptanceSamplingViewSet,
    MeasurementSystemAnalysisViewSet,
    EconomicDesignViewSet,
    SPCImplementationViewSet,
    # Simplified API views
    QuickControlChartView,
    QuickProcessCapabilityView,
    QuickAcceptanceSamplingView,
    QuickMSAView,
    SQCSimulationView,
    SQCDemoDataView,
)
