...
def register(registry: ModuleRegistry) -> None:
    ...
    module_info = {
        ...
        "tutorials": [
            {"title": "Getting Started with Control Charts", "url": "/tutorials/sqc/control-charts-intro"},
            {"title": "Performing Process Capability Analysis", "url": "/tutorials/sqc/process-capability"},
            {"title": "Designing Acceptance Sampling Plans", "url": "/tutorials/sqc/acceptance-sampling"},
            {"title": "Conducting Measurement System Analysis", "url": "/tutorials/sqc/msa"},
            {"title": "Cost Optimizing Control Charts", "url": "/tutorials/sqc/economic-design"},
            {"title": "Creating SPC Implementation Plans", "url": "/tutorials/sqc/spc-implementation"},
        ],
    }
