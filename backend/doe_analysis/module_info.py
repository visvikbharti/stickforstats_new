...
def register(registry: ModuleRegistry) -> None:
    ...
    module_info = {
        ...
        "tutorials": [
            {"title": "Getting Started with DOE", "url": "/tutorials/doe/intro"},
            {"title": "Designing Factorial Experiments", "url": "/tutorials/doe/factorial"},
            {"title": "Response Surface Methodology", "url": "/tutorials/doe/response-surface"},
            {"title": "Analyzing DOE Results", "url": "/tutorials/doe/analysis"},
            {"title": "Interpreting Effect Plots", "url": "/tutorials/doe/effect-plots"},
            {"title": "Process Optimization with DOE", "url": "/tutorials/doe/optimization"},
        ],
    }
