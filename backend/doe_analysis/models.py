...
class ExperimentDesign(models.Model):
    ...
    analysis_session = models.ForeignKey(AnalysisSession, on_delete=models.CASCADE, related_name="experiment_designs")
    analysis_result = models.OneToOneField(
        AnalysisResult, on_delete=models.CASCADE, related_name="experiment_design_detail", null=True, blank=True
    )
...
class FactorDefinition(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    experiment_design = models.ForeignKey(ExperimentDesign, on_delete=models.CASCADE, related_name="factors")
...
class ResponseDefinition(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    experiment_design = models.ForeignKey(ExperimentDesign, on_delete=models.CASCADE, related_name="responses")
...
class ModelAnalysis(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    experiment_design = models.ForeignKey(ExperimentDesign, on_delete=models.CASCADE, related_name="model_analyses")
    analysis_result = models.OneToOneField(
        AnalysisResult, on_delete=models.CASCADE, related_name="model_analysis_detail", null=True, blank=True
    )
...
class ExperimentRun(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    experiment_design = models.ForeignKey(ExperimentDesign, on_delete=models.CASCADE, related_name="runs")
...
class OptimizationAnalysis(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    experiment_design = models.ForeignKey(ExperimentDesign, on_delete=models.CASCADE, related_name="optimizations")
    analysis_result = models.OneToOneField(
        AnalysisResult, on_delete=models.CASCADE, related_name="optimization_detail", null=True, blank=True
    )

    # Link to model analysis (for optimization based on fitted model)
    model_analysis = models.ForeignKey(
        "ModelAnalysis", on_delete=models.SET_NULL, related_name="optimization_from_model", null=True, blank=True
    )
