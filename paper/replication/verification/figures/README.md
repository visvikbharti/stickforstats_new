...
| `fig4_reported_vs_recomputed_p` | log-log scatter of reported vs recomputed p for all 355 flags, colored by FP category, ★ = decision-changing — the "money plot" |
| `fig5_by_statistic_type` | flagged inconsistencies by statistic type (t / F / r / z / chi²), all vs likely-true |
| `fig6_rate_robustness` | inconsistency rate across frames: raw 11.8% · IPW 11.3% · likely-true 9.1% (95% CI [7.0, 11.5], papers as clusters) · independent OA 6.5%. **"Robust & single-digit" is retired** — the clustered interval crosses 10% |
