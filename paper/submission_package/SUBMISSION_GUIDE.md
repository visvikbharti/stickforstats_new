...
12. **Declarations.** Prepare competing-interests (declare none, or the open-source tool authorship), funding (CSIR-IGIB / any grant numbers — VERIFY with co-author), author-contributions (CRediT), and ethics (state "no human/animal subjects; all data are public secondary datasets").
