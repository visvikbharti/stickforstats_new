...
| Andreas Deutsch | andreas.deutsch@tu-dresden.de | Department of Innovative Methods of Computing (ZIH), Technische Universität Dresden, Germany | 0000-0002-9005-6897 | Leads mathematical/computational biology at TU Dresden; develops the open-source Morpheus modeling/simulation platform — research-software and computational-methods perspective for evaluating an open-source statistical-validation platform. |

**COI notes:** all four clean. Roy is PLOS Comp Biol **Section Editor** (Genomics/Epigenomics/Proteomics) and Laxman is a PLOS Academic Editor — suggesting board members is allowed, but PLOS may route Roy as the handling editor instead. Deutsch is not a PLOS board member (pure reviewer suggestion). The earlier personal-COI flag on Deutsch (possible bandmate of D. Chakraborty in the Dresden ensemble "Dhun") was **cleared by co-author D. Chakraborty on 2026-06-15: no personal connection** — included as Reviewer 4.
