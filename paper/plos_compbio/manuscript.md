...
![**Fig 3. Manuscript review workflow.** The pipeline parses manuscripts in PDF/LaTeX/DOCX format, extracts statistical claims via regex and LLM-hybrid extraction, selects a discipline profile (CONSORT, STROBE, ICH-E9, or JARS-Quant), runs seven validators in parallel, applies discipline-specific severity weights, and returns a classified statistical quality report.](figures_plos/fig3_manuscript_review.png){ width=85% }
