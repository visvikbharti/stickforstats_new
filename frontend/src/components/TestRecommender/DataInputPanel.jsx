...
const DataInputPanel = ({ 
  ...
  const sampleDatasets = [
    { id: 'iris', name: "Fisher's Iris Dataset", description: 'Classic 3-species classification (real data)' },
  ...
  // Fisher's Iris dataset — real measurements from Anderson (1935) / Fisher (1936)
  const generateIrisData = () => {
    // Sepal length, sepal width, petal length, petal width for 150 specimens
    const raw = [
      // Setosa (50)
