...
// Components for Bootstrap Methods Tab
const KeyAdvantagesCard = React.memo(() => (
...
const BootstrapPrincipleCard = React.memo(() => (
  <Card variant="outlined" sx={{ height: '100%' }}>
    <CardContent>
      <Typography variant="subtitle1" gutterBottom color="primary">
...
const PercentileBootstrapAccordion = React.memo(() => (
...
const BasicBootstrapAccordion = React.memo(() => (
  <Accordion>
    <AccordionSummary expandIcon={<ExpandMoreIcon />}>
...
const BcaBootstrapAccordion = React.memo(() => (
  <Accordion>
    <AccordionSummary expandIcon={<ExpandMoreIcon />}>
...
const StudentizedBootstrapAccordion = React.memo(() => (
  <Accordion>
    <AccordionSummary expandIcon={<ExpandMoreIcon />}>
...
const BootstrapMethodsTable = React.memo(() => (
...
// Bootstrap Methods Tab
const BootstrapMethodsTab = React.memo(() => (
  <Box>
    <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
      ...
      <PercentileBootstrapAccordion />
      <BasicBootstrapAccordion />
      <BcaBootstrapAccordion />
      <StudentizedBootstrapAccordion />
...
const BayesianApproachCard = React.memo(() => (
  <Card variant="outlined" sx={{ height: '100%' }}>
    <CardContent>
      <Typography variant="subtitle1" gutterBottom color="primary">
        Bayesian Approach
...
const CredibleIntervalsCard = React.memo(() => (
  <Card variant="outlined" sx={{ height: '100%' }}>
    <CardContent>
      <Typography variant="subtitle1" gutterBottom color="primary">
...
const EqualTailedCredibleIntervalAccordion = React.memo(() => (
  <Accordion defaultExpanded>
    <AccordionSummary expandIcon={<ExpandMoreIcon />}>
...
const HPDIntervalAccordion = React.memo(() => (
  <Accordion>
    <AccordionSummary expandIcon={<ExpandMoreIcon />}>
...
const BayesianVsFrequentistTable = React.memo(() => (
  <TableContainer component={Paper} variant="outlined">
    <Table>
      <TableHead>
        <TableRow>
...
// Bayesian Intervals Tab
const BayesianIntervalsTab = React.memo(() => (
  <Box>
    <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
      <Typography variant="h6" gutterBottom>
      ...
      <EqualTailedCredibleIntervalAccordion />
      <HPDIntervalAccordion />
...
// Robust Methods Components
const TrimmedMeanCard = React.memo(() => (
  <Card variant="outlined" sx={{ height: '100%' }}>
    <CardContent>
      <Typography variant="subtitle1" gutterBottom color="primary">
        Trimmed Mean
...
const WinsorizedMeanCard = React.memo(() => (
  <Card variant="outlined" sx={{ height: '100%' }}>
    <CardContent>
      <Typography variant="subtitle1" gutterBottom color="primary">
        Winsorized Mean
...
const MEstimatorsCard = React.memo(() => (
...
// Robust Methods Tab
const RobustMethodsTab = React.memo(() => (
  <Box>
    <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
      <Typography variant="h6" gutterBottom>
...
const ComputationalApproachesTab = React.memo(() => (
  <Box>
    <Paper elevation={2} sx={{ p: 3, mb: 3 }}>
      <Typography variant="h6" gutterBottom>
...
const CustomEducationalContent = React.memo(({ content }) => (
...
const AdvancedMethods = () => {
  ...
  const tabContent = useMemo(() => [
    <BootstrapMethodsTab key="bootstrap" />,
    <BayesianIntervalsTab key="bayesian" />,
    <RobustMethodsTab key="robust" />,
    <ComputationalApproachesTab key="computational" />
  ], []);
        ...
        {loading ? <LoadingIndicator /> : (
          <Box>
            ...
            {educationalContent.map((content) => (
              <CustomEducationalContent key={content.id} content={content} />
            ))}
          </Box>
        )}
      </Box>
...
export default React.memo(AdvancedMethods);